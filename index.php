  ...
  <main>
    ...
    <section>
      ...
      <div class="featured">
        <div class="container">
          <div class="title">
            <h3 class="title-primary h6">Website Redesign Group Project</h3>
            <h4 class="title-blue h2">Manitouadge General Hospital</h4>
          </div>
          <div class="row">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-5" data-aos="fade-right" data-aos-delay="200" data-aos-duration="800">
              <div class="title">
                <h3 class="title-primary h6">ASP.NET Passion Project</h3>
                <h4 class="h3">Art Gallery</h4>
              </div>
            ...
            <div class="col-md-5 gallery">
              <div class="row no-gutters">
                <div class="w-50 h-100 gal-img-x" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
                  <img class="img-fluid" src="img/artGallery/canvas1_2.jpg" alt="Website screenshot.">
                </div>
                <div class="w-50 h-50 gal-img-x" data-aos="fade-up" data-aos-delay="400" data-aos-duration="600">
